...
def play_onMousePress(app,mouseX,mouseY):
    if not app.showSettings and not app.sessionFinished:
...
def drawResults(app):
    ...
    drawLabel(f"{app.username}, you did it!",160+(app.width-320)/2,app.height - 450,size=40,bold=True)
    drawLabel("Over the course of 90s, you let", 160 + (app.width - 320) / 2, app.height - 390, size=20,bold=True)
    drawLabel(f'{app.carNum} cars', 160 + (app.width - 320) / 2, app.height - 350, size=40, bold=True)
    drawLabel('safely reached their destinations, with the average time spent:', 160 + (app.width - 320) / 2, app.height - 290, size=20, bold=True)
    drawLabel(f'{app.aveTime} s!', 160 + (app.width - 320) / 2, app.height - 250, size=40, bold=True)
